...
<main className="container-fluid rounded-5 aboutUs text-white my-4" style={{"backgroundColor": "#7A56D0"}}>
        <div className="row container-aboutUs">
            ...
            <div className="col-12 col-lg-5 px-4 pt-3 align-content-center">
                ...
                <p className="text-center">En EducAprende, creemos que la educación es un juego y que aprender debe ser divertido. Por eso, ofrecemos una amplia variedad de juegos educativos que te ayudarán a aprender mientras te diviertes.                    
                </p>
            </div>
